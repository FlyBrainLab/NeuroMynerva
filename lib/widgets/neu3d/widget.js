...
* An Neu3D Widget
*/
export class Neu3DWidget extends FBLWidget {
    constructor(options) {
        var _a, _b;
        super(Object.assign({ name: options.name || `Neu3D-${Private.count++}`, icon: Icons.neu3DIcon }, options));
        this._neu3DReady = new PromiseDelegate();
        this._workspaceChanged = new Signal(this);
        // load in meshes
        ...
        if (((_a = options.model) === null || _a === void 0 ? void 0 : _a.metadata) || ((_b = options.model) === null || _b === void 0 ? void 0 : _b.states)) {
            this.neu3DReady.then(() => {
                ...
                acceptBtn.onclick = () => {
                    var _a, _b;
                    try {
                        if (!objEmpty((_a = options.model) === null || _a === void 0 ? void 0 : _a.metadata)) {
                            this.neu3d.import_settings(options.model.metadata);
                        }
                        if (!objEmpty((_b = options.model) === null || _b === void 0 ? void 0 : _b.states)) {
    ...
    renderModel(change) {
        for (const [key, value] of Object.entries(this.model.data)) {
            ...
            if (typeof (color) === 'number') {
                value.color = toHexString(color);
            }
            if ('type' in value) {
                this.neu3d.addJson({ ffbo_json: data, type: value.type });
            }
            else {
    ...
    onStatesChanged(change) {
        // this.renderModel(change);
        // no-op
        return;
    }
    onMetadataChanged(change) {
        // do nothing
        // this.renderModel(change);
        return;
    }
    ...
    onCommMsg(msg) {
        ...
        if (thisMsg.widget == 'NLP') {
            ...
            (_a = this.info) === null || _a === void 0 ? void 0 : _a.dataChanged.emit({
    ...
    */
    ...
    onAfterAttach(msg) {
        ...
        if (!this.neu3d) {
            this.neu3d = new Neu3D(this._neu3dContainer, undefined, {
        ...
        this.neu3d.settings.on("change", ((e) => {
        ...
        this.neu3d.settings.toneMappingPass.on('change', ((e) => {
            let settings = this.neu3d.export_settings();
            this.model.metadata = settings;
            this.model._metadataChanged.emit(settings);
            this._modelChanged.emit(e);
        ...
        this.neu3d.controls.addEventListener('end', (e) => {
    ...
    onAfterShow(msg) {
        var _a;
        (_a = this.neu3d) === null || _a === void 0 ? void 0 : _a.onWindowResize();
        if (!objEmpty(this.model.metadata)) {
            this.neu3d.import_settings(this.model.metadata);
        }
        if (!objEmpty(this.model.states)) {
    ...
    populateToolBar() {
        this.toolbar.addItem('upload', Private.createButton(Icons.uploadIcon, "Upload SWC File", 'jp-Neu3D-Btn jp-SearBar-upload', () => { this.neu3d.fileUploadInput.click(); }));
        this.toolbar.addItem('reset', Private.createButton(Icons.syncIcon, "Reset View", 'jp-Neu3D-Btn jp-SearBar-reset', () => { this.neu3d.resetView(); }));
        this.toolbar.addItem('zoomToFit', Private.createButton(Icons.zoomToFitIcon, "Center and zoom into visible Neurons/Synapses", 'jp-Neu3D-Btn jp-SearBar-zoomToFit', () => { this.neu3d.resetVisibleView(); }));
        this.toolbar.addItem('hideAll', Private.createButton(Icons.eyeSlashIcon, "Hide All", 'jp-Neu3D-Btn jp-SearBar-hideAll', () => { this.neu3d.hideAll(); }));
        this.toolbar.addItem('showAll', Private.createButton(Icons.eyeIcon, "Show All", 'jp-Neu3D-Btn jp-SearBar-showAll', () => { this.neu3d.showAll(); }));
        ...
        this.toolbar.addItem('unpinAll', Private.createButton(Icons.mapUpinIcon, "Unpin All", 'jp-Neu3D-Btn jp-SearBar-unpin', () => { this.neu3d.unpinAll(); }));
        this.toolbar.addItem('removeUnpinned', Private.createButton(Icons.trashIcon, "Remove Unpinned Neurons", 'jp-Neu3D-Btn jp-SearBar-remove-unpinned', () => { this.neu3d.removeUnpinned(); }));
