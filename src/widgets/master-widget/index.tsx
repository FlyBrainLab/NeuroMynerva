  ...
  class Item extends React.Component<{
    ...
    constructor(props: {
      ...
      if (this.widget instanceof Neu3DWidget) {
        ...
        this._neuropilTableId = `Neu3D-Neuropil-Table-${this.widget.id}`;
      }
    }
    ...
    componentDidMount() {
      if (this.widget instanceof Neu3DWidget) {
        this.neu3dTables = new Neu3DModelTable({
          ...
          neuropilContainer: this._neuropilTableId,
          neu3d: this.widget as Neu3DWidget,
          labShell: this.labShell
        });
        this.neu3dTables.neuronTabulator.redraw();
        this.neu3dTables.neuronTabulator.setPage(1);
        this.neu3dTables.neuropilTabulator.redraw();
        this.neu3dTables.neuropilTabulator.setPage(1);
      }
    }
                      ...
                      <>
                        ...
                        >
                          <ToolbarButtonComponent
                            ...
                            icon={Icons.eyeIcon}
                            onClick={() => {
                              (this.widget as Neu3DWidget).neu3d.showFrontAll();
                            }}
                          ...
                          <ToolbarButtonComponent
                            ...
                            onClick={() => {
                              (this.widget as Neu3DWidget).neu3d.hideFrontAll();
                            }}
                          ...
                          <ToolbarButtonComponent
                            ...
                            tooltip={'Remove All Active Neurons & Synapses'}
                          />
                        </div>
                      </>
                    }
                      ...
                      <>
                        ...
                        >
                          <ToolbarButtonComponent
                            ...
                            icon={Icons.eyeIcon}
                            onClick={() => {
                              (this.widget as Neu3DWidget).neu3d.showBackAll();
                            }}
                            tooltip={'Show All Neuropils'}
                          />
                          <ToolbarButtonComponent
                            key={1}
                            icon={Icons.eyeSlashIcon}
                            onClick={() => {
                              (this.widget as Neu3DWidget).neu3d.hideBackAll();
                            }}
                            tooltip={'Hide All Neuropils'}
                          />
                          <ToolbarButtonComponent
                            key={2}
                            icon={Icons.trashIcon}
                            onClick={() => {
                              this.neu3dTables.removeAllNeuropils(true);
                            }}
                            tooltip={'Remove All Active Neuropils'}
                          />
                        </div>
                      </>
                    }
