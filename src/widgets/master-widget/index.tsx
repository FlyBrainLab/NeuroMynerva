...
namespace FBLWidgetReact {
      ...
      if (this.widget instanceof Neu3DWidget) {
                      ...
                      <>
                        ...
                        <div className={`${COLLAPSIBLE_SECTION_HEADER_BUTTONS}`}>
                          ...
                          <ToolbarButtonComponent
                            ...
                            tooltip={'Remove All Active Unpinned Neurons & Synapses'}
                          />
                        </div>
                      </>
                    }
                    children={<div className={NEU3D_TABLE} id={this._neuronTableId}></div>}
                  ></CollapsibleSection>
                  <CollapsibleSection
                    title={
                      <>
                    ...
                    children={<div className={NEU3D_TABLE} id={this._meshTableId}></div>}
                  ></CollapsibleSection>
                </>
              }
            ></CollapsibleSection>
        ...
        return (
          <header className={ITEM_CLASS}>
            ...
            <button className={`${DISPOSE_BUTTON_CLASS} jp-mod-styled`} onClick={() => this.panel.dispose()}>
              CLOSE
            </button>
            <UseSignal signal={this.widget.sessionContext.sessionChanged}>
              {(_, args) => {
  ...
  export function ShutdownButton(props: { widget: IFBLWidget; sessionManager: SessionManager }): JSX.Element {
    const { widget } = props;
    ...
    return (
      <button className={`${DISPOSE_BUTTON_CLASS} jp-mod-styled`} onClick={onShutdown}>
        SHUTDOWN
      </button>
    );
  }
