...
import { ToolbarButton, UseSignal, ToolbarButtonComponent, ReactWidget } from '@jupyterlab/apputils';
...
export class NeuGFXWidget extends FBLWidget implements IFBLWidget {
  constructor(options: FBLWidget.IOptions, iFrameSrc?: string) {
    ...
    Event.prototype.stopPropagation = function () {};  // eslint-disable-line
