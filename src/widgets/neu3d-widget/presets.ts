...
export const PRESETS: {[name in PRESETS_NAMES]: PresetEntry} = {
  'larva(l1em)': {
    ...
    'hints': [
      ...
      {query:`show neurons in right MB`, effect:`show all neurons that have arborizations in MB.`},
      {query:`add postsynaptic gabaergic $MBON$ neurons with at least 10 synapses`, effect:`add all GABAergic MBON neurons that are postsynaptic to the neurons in the current workspace and that have a connection with more than 10 synapses.`}
    ]
  },
  'adult(flycircuit)': {
    ...
    'hints': [
      ...
      {query:`show neurons in EB`, effect:`show all neurons that have arborizations in EB.`},
      {query:`add postsynaptic $PEG$ neurons with at least 10 synapses`, effect:`add all PEG neurons that are postsynaptic to the neurons in the current workspace and that have a connection with more than 10 synapses.`}
    ]
  },
  'adult(hemibrain)': {
    ...
    'hints': [
      ...
      {query:`show neurons in right MB`, effect:`show all neurons that have arborizations in MB.`},
      {query:`add postsynaptic $PEG$ neurons with at least 10 synapses`, effect:`add all PEG neurons that are postsynaptic to the neurons in the current workspace and that have a connection with more than 10 synapses.`},
      {query:`show neurons that have dendrites in EB and axons in PB`, effect:`show neurons that have input site from EB and has output sites in PB.`},
    ]
  },
  'default': {
