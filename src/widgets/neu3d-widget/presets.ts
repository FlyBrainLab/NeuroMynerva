  ...
  'larva(l1em)': {
    ...
    hints: [
      ...
      },
      {
        ...
        examples: ['"show $MBON$ neurons", or simply "show $MBON$", will query any neuron whose name contain the string *MBON*']
      },
      {
        ...
        examples: ['"show /rM(.*)d1(.*)/r neurons", or simply "show /rM(.*)d1(.*)/r" will show neurons whose name starts with M and has d1.']
      },
      {
        query: 'show neurons in|that innervate|that arborize in neuropil/subregion',
        effect: 'Shows neurons that has output or input in a neuropil or a subregion of a neuropil.',
        examples: ['"show neurons in left antennal lobe", or using abbreviations "show neurons in left AL"',
      ...
      },
      {
        ...
        effect: ' Shows the neurons that has only inputs and outputs within the neuropil (note that due to lack of data in some datasets, some neurons are only traced in one neuropil and thus are classified local neuron by default).',
        examples: ['"show local neurons in antennal lobe"']
      },
      {
        query: 'show neurons with|that have inputs|outputs in neuropil/subregion',
        effect: 'More specific then the previous query on the inputs or outputs.',
        examples: ['"show neurons with inputs in left AL"',
      ...
      },
      {
        ...
        effect: 'Shows the neurons that are presynaptic or postsynaptic to the neurons defined after the word to.',
        examples: ['"show neurons presynaptic to broad local neurons in right antennal lobe"',
                   '"show $DAN$ presynaptic to $MBON-d1$ in right MB"']
      },
      {
        query: 'show presynaptic|postsynaptic neurons',
        effect: 'Shows the neurons that are presynaptic or postsynaptic to the neurons already in workspace.',
        examples: ['"show presynaptic neurons"',
      ...
      },
      {
        ...
        examples: ['"show GABAergic neurons in AL"',
      ...
      },
      {
        ...
        examples: ['"show A neurons", then "add B neurons", then "color red" will color B neurons red. "color A neurons 0000FF" will then color A neurons blue.']
      }
    ]
  },
  'adult(medulla)': {
    ...
    hints: [
      ...
      },
      {
        query: 'show $string$ neurons',
        effect: 'Shows neurons with a name that contains the string.',
        examples: ['"show $T4a$ neurons", or simply "show $T4a$", will query any neuron whose name contain the string *T4a*']
      },
      {
        query: 'show /rstring/r neurons',
        effect: 'Show neurons whose name matches the regular expressing string (This requires some knowledge of how the neurons are named in each dataset).',
        examples: ['"show /rTm2-[A-C]/r neurons", or simply "show /rTm2-[A-C]/r" will show the Tm2 neurons in the A, B, C columns']
      },
      {
        query: 'show neurons with|that have inputs|outputs in neuropil/subregion',
        effect: 'More specific then the previous query on the inputs or outputs.',
      ...
      },
      {
        query: 'show neurons presynaptic|postsynaptic to',
        effect: 'Shows the neurons that are presynaptic or postsynaptic to the neurons defined after the word to.',
        examples: ['"show neurons presynaptic to $T4a-fb-home$"',
      ...
      },
      {
        query: 'show neurotransmitter neurons',
        effect: 'Shows the neurons that express the neurotramsitter',
        examples: ['"show GABAergic neurons"',
                   '"show cholinergic presynaptic neurons"']
      },
      {
    ...
    hints: [
      {
        query: 'show $string$ neurons',
        effect: 'Shows neurons with a name that contains the string.',
        examples: ['"show $E0585$ neurons", or simply "show $E0585$", will query any neuron whose name contain the string *E0585*.']
      },
      {
        query: 'show /rstring/r neurons',
        effect:
          'Show neurons whose name matches the regular expressing string (This requires some knowledge of how the neurons are named in each dataset).',
        examples: ['"show /r(.*)TH-F-[1-2](.*)2/r neurons", or simply "show /r(.*)TH-F-[1-2](.*)2/r" will show dopaminergic neurons (TH gene) with the FlyCircuit ID number starting with 1 or 2 and end with 2']
      },
      {
        query: 'show neurons in|that innervate|that arborize in neuropil/subregion',
        effect: 'Shows neurons that has output or input in a neuropil or a subregion of a neuropil.',
        examples: ['"show neurons in ellipsoid body", or using abbreviations "show neurons in EB"',
                   '"show neurons that innervate right al and right mb". Note that this is different from "show neurons that innervate right al or right mb".']
      },
      {
        query: 'show neurons with|that have inputs|outputs in neuropil/subregion',
      ...
      },
      {
        ...
        examples: ['"show neurons with inputs in OPTU"',
      ...
      },
      {
        ...
        examples: ['"show neurons presynaptic to $TH-F-700014$ in right medulla"',
      ...
      },
      {
        query: 'show neurotransmitter neurons',
        effect:
          'Shows the neurons that express a specified neurotramsitter.',
        examples: ['"show GABAergic neurons in EB"',
                   '"show cholinergic presynaptic neurons"',
                   '"show glutamatergic local neurons in AL"']
      },
      {
  ...
  'adult(hemibrain)': {
    ...
    hints: [
      ...
      },
      {
        query: 'show $string$ neurons',
        effect:
          'Shows neurons with a name that contains the string.',
        examples: ['"show $PEG$ neurons", or simply "show $PEG$", will query any neuron whose name contain the string *PEG*.']
      },
      {
        query: 'show /rstring/r neurons',
        effect: 'Show neurons whose name matches the regular expressing string (This requires some knowledge of how the neurons are named in each dataset).',
        examples: ['"show /r(.*)PEG(.*)R1(.*)/r neurons", or simply "show /r(.*)PEG(.*)R1(.*)/r" will show the PEG neurons that innervate PB glomerulus R1.']
      },
      {
        query: 'show neurons in|that innervate|that arborize in neuropil/subregion',
        effect: 'Shows neurons that has output or input in a neuropil or a subregion of a neuropil.',
      ...
      },
      {
        ...
        effect:
          'More specific then the previous query on the inputs or outputs.',
        examples: ['"show neurons with inputs in AME"',
      ...
      },
      {
        ...
        effect:
          'Shows the neurons that are presynaptic or postsynaptic to the neurons defined after the word to.',
        examples: ['"show neurons presynaptic to TuBu05"',
