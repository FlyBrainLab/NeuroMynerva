...
var defaultFilters = {
	//equal to
	"=": function(filterVal: string,
    rowVal: string,
    rowData: string,
    filterParams: any): boolean {
  ...
  "regex":function(filterVal: string,
    rowVal: string,
    rowData: string,
    filterParams: any): boolean {
	...
	//contains the string
	"like":function(filterVal: string,
    rowVal: string,
    rowData: string,
    filterParams: any): boolean {
	...
	"keywords":function(filterVal: string,
    rowVal: string,
    rowData: string,
    filterParams: any): boolean {
...
export function combinedFilter(filterVal: string,
  rowVal: string,
  rowData: string,
  filterParams: any): boolean {
...
export function numberFilter(filterVal: string,
    rowVal: string,
    rowData: string,
    filterParams: any): boolean {
  if (isNumeric(filterVal) ) {
    ...
    if ( lastCharacters !== null ) {
      ...
      if (operator === '=') {
        return defaultFilters['='](lastCharacters[0], rowVal, rowData, filterParams);
      }
      if (operator === '>=') {
        return defaultFilters['>='](lastCharacters[0], rowVal, rowData, filterParams);
      }
