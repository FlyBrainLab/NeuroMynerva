 ...
 */
class SummaryTable extends widgets_1.Widget {
    constructor() {
        super();
                ...
                if ("Images" in extraData) {
                    ...
                    imgList.forEach(function (imgName, idx) {
                        ...
                        if (extraData["Images"][imgName]) {
                            ...
                            $('#' + current_obj.extraImgId + " img")[idx].src = "https://neuronlp.fruitflybrain.org" + _source;
                        }
                        else {
...
(function (Private) {
    ...
    Private.snakeToSentence = snakeToSentence;
    /**
    ...
    Private.verifyDataIntegrity_ST = verifyDataIntegrity_ST;
    // /**
...
//# sourceMappingURL=summary_table.js.map